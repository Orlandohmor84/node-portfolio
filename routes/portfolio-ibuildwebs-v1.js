...
router.get('/', function(req, res, next) {
  res.render('portfolio-ibuildwebs-v1', 
    { title: 'iBuildWebs v1',
      ...
      summary_p2: 'Exact website was replicated four times using four distinct ways to build including Angular, jQuery, PHP, and W3.JS.',
      link: 'https://v1.ibuildwebs.online/'
  });
});
